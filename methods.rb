# 1. Define a method #greet_programmer that takes no arguments. 
#It should output the string "Hello, programmer!" to the terminal with #puts.

def greet_programmer()
    puts "Hello, programmer!"
end

# 2. Define a method #greet that takes one argument, a name. 
...
# 3. Define a method #greet_with_default that takes one argument, a name. 
#It should output the string "Hello, name!" (with "name" being whatever value was passed as an argument) to the terminal with #puts. 
